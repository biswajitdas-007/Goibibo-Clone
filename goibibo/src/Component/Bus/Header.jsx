...
export function Header1() {
    ...
    const {  handleFilter } = useContext(AuthContext);
                    ...
                    <div className="eMfvSP">
                            ...
                            <div className="leftside-start">
                                <div className="fzifhO">
                                    <div className="jfGVSI">
                                        ...
                                        <Link className="dafNvA" to="/bus">Reset All</Link>

                                    </div>
                                <div className="jfgoXB">
                                    <div className="dJEHuf">
                                        <span className="dIeNlA">popular</span>
                                        <Link className="dafNvA" to="/bus" >Reset</Link>
                                    </div>
                                ...
                                <div className="jfgoXB">
                                    ...
                                    <div className="faQIkU">
                                        <div onClick={handledivclick} value="AC" className="djZxHm">
                        ...
                        <div className="righside-start">
                            ...
                            <div className="cpuulD">
                                ...
                                <span className="span-br">FASTEST</span>
                                <span className="span-br">CHEAPEST</span>
