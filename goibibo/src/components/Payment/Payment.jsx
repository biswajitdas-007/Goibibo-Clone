                        ...
                        <div className="bus-div" >
                            ...
                            <div className="price-div" >
                                ...
                                <div className="collapse" id="hide">
                                    <div className="price-fare " style={{display:"flex"}}>
                                    <div className=" price-fare base-fair">
                                    ...
                                    <div id="coupons" style={{ backgroundColor: "white" }}>
                                        <div id="passenger">
                                            ...
                                            <div style={{display:"flex", gap:"10px"}}>
                                                ...
                                                <div >
                                                    <h3 style={{padding:"0", margin:"0", fontSize:"15px",}}>godhani</h3>
                                                </div>
                                                </div>
                                                <hr />
                                                <div>
                                                    <p style={{
                                                       ...
                                                       GODHANI: Get FLAT 8% OFF on your Bus booking using Dhani Cards
                                                    </p>
                                                </div>
                                        </div>
                                        <div id="passenger">
                                            <div style={{display:"flex", gap:"10px"}}>
                                                ...
                                                <div >
                                                    <h3 style={{padding:"0", margin:"0", fontSize:"15px",}}>goamazon</h3>
                                                </div>
                                                </div>
                                                <hr />
                                                <div>
                                                    <p style={{
                                                        ...
                                                        GOAMAZON: Up to 4% Instant Discount + 6% Cashback into Amazon Pay upto Rs. 600
                                                    </p>
                                                </div>
                                            </div>
                                            <div id="passenger">
